    ...
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-1 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16  rounded-full border-solid">
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4 ml-[40%]">About Me</h2>
          <p className="text-base lg:text-lg">
            My name is Dang Van Phu. I was born 2000. I’m graduated Nguyen Tat Thanh University (NTTU)
